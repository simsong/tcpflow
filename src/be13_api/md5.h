 ...
 */
inline void MD5Init(context_md5_t *ctx)
{
 ...
 * of bytes.
 */
inline void MD5Update(context_md5_t *ctx, const unsigned char *buf, size_t len)
{
    uint32_t t;
 ...
 */
inline void MD5Final(unsigned char digest[16], context_md5_t *ctx)
{
    unsigned count;
    unsigned char *p;
 ...
 */
inline void MD5Transform(uint32_t buf[4], uint32_t const in[16])
{
